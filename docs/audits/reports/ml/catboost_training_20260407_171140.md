...
|--------|---------|----------|--------|
| accuracy | 0.4828 | 0.7483 | CatBoost |
| precision | 0.1648 | 0.629 | CatBoost |
| recall | 0.1685 | 0.4382 | CatBoost |
| f1 | 0.1667 | 0.5166 | CatBoost |
| roc_auc | 0.2898 | 0.8006 | CatBoost |
| log_loss | 1.0258 | 0.5574 | CatBoost |

### Regressor (`sl_remaining_r`)

| Metric | XGBoost | CatBoost | Winner |
|--------|---------|----------|--------|
| rmse | 0.9212 | 0.799 | CatBoost |
| mae | 0.8 | 0.5232 | CatBoost |
| r2 | -0.1961 | 0.1002 | CatBoost |
...
| 21 | setup_type | categorical (native) |
| 22 | regime_at_entry | categorical (native) |
