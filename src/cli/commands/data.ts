...
import * as core from '../../core/tradingview/data.js';
...
register('ohlcv', {
  ...
  handler: (opts) => core.getOhlcv({
    ...
    summary: opts.summary as boolean | undefined,
  }),
});
...
register('data', {
  ...
  subcommands: new Map([
    ['lines', {
      ...
      handler: (opts: Record<string, unknown>) => core.getPineLines({ study_filter: opts.filter as string | undefined, verbose: opts.verbose as boolean | undefined }),
    }],
    ['labels', {
      ...
      handler: (opts: Record<string, unknown>) => core.getPineLabels({ study_filter: opts.filter as string | undefined, max_labels: opts.max ? Number(opts.max) : undefined, verbose: opts.verbose as boolean | undefined }),
    }],
    ['tables', {
      ...
      handler: (opts: Record<string, unknown>) => core.getPineTables({ study_filter: opts.filter as string | undefined }),
    }],
    ['boxes', {
      ...
      handler: (opts: Record<string, unknown>) => core.getPineBoxes({ study_filter: opts.filter as string | undefined, verbose: opts.verbose as boolean | undefined }),
    }],
    ['strategy', {
    ...
    ['trades', {
      ...
      handler: (opts: Record<string, unknown>) => core.getTrades({ max_trades: opts.max ? Number(opts.max) : undefined }),
    }],
    ['equity', {
