...
import * as core from '../../core/tradingview/replay.js';
...
register('replay', {
  ...
  subcommands: new Map([
    ['start', {
      ...
      handler: (opts: Record<string, unknown>) => core.start({ date: opts.date as string | undefined }),
    }],
    ['step', {
    ...
    ['autoplay', {
      ...
      handler: (opts: Record<string, unknown>) => core.autoplay({ speed: opts.speed ? Number(opts.speed) : undefined }),
    }],
    ['trade', {
